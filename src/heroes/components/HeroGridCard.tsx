        ...
        <>
            <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
                <div className="relative h-64">
                    ...
                    {/* Universe badge */}
                    <Badge className={cn(hero.universe === 'DC' ? "bg-green-600" : 'bg-red-500', "absolute top-3 right-3 text-xs text-white")}>
                        {hero.universe}
                    </Badge>
                    ...
                    >
                        <Heart className={isFavorite(hero) ? "fill-red-500 text-red-500" : "h-4 w-4"} />
                    </Button>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1">
                            <div className="flex items-center gap-1">
                                ...
                                <span className="text-xs font-medium">{hero.strength * 10}</span>
                            </div>
                        ...
                        <div className="space-y-1">
                            <div className="flex items-center gap-1">
                                ...
                                <span className="text-xs font-medium">{hero.intelligence * 10}</span>
                            </div>
                        ...
                        <div className="space-y-1">
                            <div className="flex items-center gap-1">
                                ...
                                <span className="text-xs font-medium">{hero.speed * 10}</span>
                            </div>
                        ...
                        <div className="space-y-1">
                            <div className="flex items-center gap-1">
                                ...
                                <span className="text-xs font-medium">{hero.durability * 10}</span>
                            </div>
