...
export const HeroStats = () => {
    ...
    if (!summary) return (<h3>Loading heroe summary...</h3>)

    const porcentageFavorite = ((favoriteCount / summary.totalHeroes) * 100).toFixed(2);
        ...
        <>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                >
                    ...
                    <p data-testid="favorite-percentage" className="text-xs text-muted-foreground">{porcentageFavorite}% of total</p>
                </HeroStatCard>
